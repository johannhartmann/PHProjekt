...
class Cleaner_Engine
{
     ...
     *
     * This method takes a type, a value, and an optional messages object, and validates the value against the specified type.
     * It uses the Cleaner_Validator class to perform the validation.
     * If the type is not supported, it throws a Cleaner_Exception.
     *
     * @param string $type The type to validate the value against
     * @param mixed $value The value to be validated
     * @param object $messages An optional object to store validation messages
     * @return boolean True if the value is valid, false otherwise
     * @throws Cleaner_Exception The specified type is not supported by the Cleaner_Validator
     */
